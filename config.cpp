...
const char LENC_TOP = 'F';
const char LENC_BOT = 'B';
const char RENC_TOP = 'G';
const char RENC_BOT = 'H';
...
pros::Motor lift2(LIFT2, pros::E_MOTOR_GEARSET_18,false, pros::E_MOTOR_ENCODER_DEGREES);
pros::ADIEncoder left_enc (LENC_TOP, LENC_BOT, true);
pros::ADIEncoder right_enc (RENC_TOP, RENC_BOT, false);
